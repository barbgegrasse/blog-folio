...
class FullpageWrapper extends React.Component {
  ...
  componentDidMount() {
    ...
    new TimelineMax()
      ...
      .to(
        '#blockSpan',
        0.5,
        { xPercent: 24, ease: Power2.easeInOut },
        'ouverture'
      )
      .to(
        '#fonction',
  ...
  clickNext() {
    ...
    if (nextProject < this.state.projects.length) {
      new TimelineMax()
        .to(
          `.bloc-presentation.${this.state.projects[currentProject]} .title-project`,
          1,
          { xPercent: -100, ease: Power4.easeInOut }
        )
        .to(
          `.bloc-presentation.${this.state.projects[currentProject]} .desc-project`,
          1,
          { xPercent: -100, ease: Power4.easeInOut },
          '-=0.8'
        )
        ...
        .to(
          ...
          1,
          { scaleX: 0.8, scaleY: 0.8, ease: Power4.easeInOut },
          '-=1.5'
        )
        .to('#fullpage', 0.5, {
          backgroundImage:
            '-webkit-linear-gradient(180deg, rgb(206, 38, 93) 100%, #ffffff 34%)',
          ease: Power1.easeInOut,
        })
        .to('#fullpage', 0.5, {
          backgroundImage:
            '-webkit-linear-gradient(180deg, rgb(61, 31, 93) 34%, #ffffff 34%)',
          ease: Power1.easeInOut,
        })
        ...
        .to(
          '.illu-project-wrapper.' +
            this.state.projects[nextProject] +
            ' .gatsby-image-wrapper',
          1,
          { xPercent: -100, ease: Power4.easeInOut },
          '-=1'
        ...
        .to(
          '.count .item.' + this.state.projects[currentProject],
          1.2,
          { yPercent: -300, ease: Power1.easeInOut },
          '-=0.8'
        )
        .to(
          '.count .item.' + this.state.projects[nextProject],
          0.5,
      ...
      new TimelineMax()
        .set('.bloc-presentation.' + this.state.projects[nextProject], {
          className: '+=current',
        })
        .to(
          '.bloc-presentation.' +
  ...
  clickPrev() {
    ...
    if (prevProject > -1) {
      new TimelineMax()
        ...
        .to(
          '.illu-project-wrapper.' +
            this.state.projects[prevProject] +
            ' .gatsby-image-wrapper',
          1,
          { xPercent: -100, ease: Power4.easeInOut },
          '-=1'
        ...
        .to(
          '.count .item.' + this.state.projects[prevProject],
          0.5,
          { yPercent: -100, ease: Power1.easeInOut },
          '-=0.8'
        )
      ...
      //Mise à jour du project suivant
      new TimelineMax()
        .set('.bloc-presentation.' + this.state.projects[prevProject], {
          className: '+=current',
        })
        .to(
          '.bloc-presentation.' +
      ...
      //Mise à jour du projet courant
      this.setState({ currentProject: prevProject })
    }
  }
            ...
            if (origin.index == 0) {
              ...
              if (this.state.animProject) {
                new TimelineMax()
                  ...
                  .to(
                    '.' + this.state.projects[0] + ' .title-project',
                    0.8,
                    { xPercent: 100, ease: Power4.easeInOut },
                    '-=0.8'
                  )
                  .to(
                    '.' + this.state.projects[0] + ' .block-span',
                    0.5,
                    { xPercent: 100, ease: Power4.easeInOut },
                    '-=0.6'
                  )
                  .to(
                    '.' + this.state.projects[0] + ' .desc-project',
                    0.8,
                    { xPercent: 100, ease: Power4.easeInOut },
                    '-=0.6'
                  )
                  .to(
                    '.' + this.state.projects[0] + ' .technos',
                    0.8,
                    { xPercent: 100, ease: Power4.easeInOut },
                    '-=0.6'
                  )
                ...
                <div>
                  ...
                  <SectionProjects>
                    <div className="bloc-presentation current project1">
                      <h2 id="soccertitle" className="title-project">
                        Soccer Park
                      </h2>
                      ...
                      <p className="technos">
                        <Technos>HTML/JS/CSS/SASS/PHP</Technos>
                      </p>

                      <a className="link-project" href="#">
                        <LinkProject>Découvrir le projet en ligne</LinkProject>
                      </a>
                    </div>
                    ...
                    <div className="bloc-presentation project3">
                      ...
                      <p className="desc-project">
                        Personnalisation du thème, configuration et installation
                        des plugins e-commerces.
                      </p>
                      <p className="technos">
                        <Technos>Wordpress + Woocommerce</Technos>
                      </p>
